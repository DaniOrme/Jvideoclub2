...
<html>
    <head>
        ...
        <title><g:message code="Baja Socio" args="[entityName]" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><p align="center"><g:message  code="Elija el socio que desea dar de baja:"   args="[entityName]" /></h1>
            <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
            </g:if>
            <div class="darBajaSocio">
                <table>
                    <thead>
                        <tr>
				...
				<g:each in="${socioInstanceList}" status="i" var="socioInstance">
                        ...
                        <td><g:link action="delete" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');"  id="${socioInstance.id}">${fieldValue(bean: socioInstance, field: "dni")}    </g:link></td>
