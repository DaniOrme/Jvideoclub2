...
<html>
    ...
    <body>
        ...
        <div class="body">
            <h1><p align="center"><g:message  code="Elija el socio que desea mostrar:"   args="[entityName]" /></h1>
            <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
            </g:if>
            <div class="mostrarSocio">
                <table>
                    <thead>
                        <tr>
				...
				<g:each in="${socioInstanceList}" status="i" var="socioInstance">
                        ...
                        <td><g:link action="mostrar" id="${socioInstance.id}">${fieldValue(bean: socioInstance, field: "dni")}    </g:link></td>
